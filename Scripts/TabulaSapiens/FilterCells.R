...
# open pdf with lines corresponding to thresholds used per cell type
...
for(file in files){
  ...
  cell_types <- names(which(table(sce$cell_ontology_class) > 100))
  ...
  pdf(paste0("../../Plots/Tabula_Sapiens/QC/filters_",tissue,"_",METHOD,".pdf"),
      height = 9)
  ...
  sce <- sce[, keep]
  saveRDS(sce, paste0("../../Outputs/Tabula_Sapiens/CellFiltered/",
                      METHOD,"_",tissue,".rds"))
